...
public class EncryptorTester
{
    ...
    Encryptor encrypt = new Encryptor(5, 6);
    String actualMessage = encrypt.encryptMessage("I don't know what to write for this message but there are other messages above!");
    System.out.println(actualMessage);

    Encryptor encrypt1 = new Encryptor(3, 3);
    String actualMessage1 = encrypt1.decryptMessage("Trahere e  t2lt6eeritsnh  e gsElhni lggauena, ve5ol ws,n2 d1a  csaoonnntsAA.AAAAA");
    System.out.println(actualMessage1);

    Encryptor encrypt2 = new Encryptor(5, 7);
    String actualMessage2 = encrypt2.decryptMessage("Riatyesnotd s hdtweiihevntereg   r.");
